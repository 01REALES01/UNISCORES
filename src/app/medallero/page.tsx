...
export default function MedalleroPage() {
    return (
        <div className="min-h-screen bg-[#030711] text-white selection:bg-indigo-500/30">

            {/* Header Simple */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#030711]/80 backdrop-blur-xl border-b border-white/5">
                <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-lg font-bold tracking-tight">Volver al Inicio</h1>
                    </div>
