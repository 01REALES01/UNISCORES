...
export default function PublicMatchDetail() {
    ...
    const fetchData = async () => {
        ...
        setFetchError(null);
        try {
            // ── Query principal con joins FK a carreras ──────────────────────
            // Columnas confirmadas en el schema de la BD:
            ...
            if (matchRes.error && !matchRes.data) {
                // ── Fallback: query sin joins cuando falla el schema cache ──
            ...
            // ── Eventos y pronósticos en paralelo ───────────────────────────
