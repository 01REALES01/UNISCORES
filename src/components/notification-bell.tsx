...
export function NotificationBell() {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            {/* Dropdown */}
            {isOpen && (
                <div className="fixed sm:absolute right-4 sm:right-0 top-[76px] sm:top-full mt-0 sm:mt-3 w-[calc(100vw-32px)] sm:w-[380px] max-h-[calc(100vh-110px)] sm:max-h-[520px] bg-background/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden z-[500] animate-in fade-in slide-in-from-top-4 duration-300 origin-top-right">
                    {/* Header */}
