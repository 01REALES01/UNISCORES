                ...
                {mobileMenuOpen && (
                    <>
                        ...
                        <m.div
                            ...
                            className="fixed inset-y-0 left-0 w-[85%] max-w-[320px] bg-background border-r border-white/10 z-[9999] lg:hidden flex flex-col shadow-[20px_0_50px_rgba(0,0,0,0.5)] overflow-hidden"
                        >
